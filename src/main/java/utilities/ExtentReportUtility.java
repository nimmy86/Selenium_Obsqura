...
public class ExtentReportUtility {
	...
	ExtentSparkReporter reporter = new ExtentSparkReporter("./extent-reports/extent-report.html"); //create a folder extend-report, and the file format is mentioned here.
